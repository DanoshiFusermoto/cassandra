...
public final class GetAtomPoolInventoryMessage extends Message
{
	@JsonProperty("head")
	...
	private GetAtomPoolInventoryMessage()
	{
		super();
	}
	
	public GetAtomPoolInventoryMessage(final BlockHeader head)
	{
		super();
