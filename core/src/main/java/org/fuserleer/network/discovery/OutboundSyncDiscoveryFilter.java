...
public class OutboundSyncDiscoveryFilter extends StandardDiscoveryFilter
{
	private final Set<Long>	shardGroups;
	
	public OutboundSyncDiscoveryFilter(final Context context, final Set<Long> shardGroups)
	{
		super(context);
