...
import org.fuserleer.serialization.ClassScanningSerializationPolicy;
import org.fuserleer.serialization.SerializationPolicy;
...
public final class ClasspathScanningSerializationPolicy extends ClassScanningSerializationPolicy {
	...
	private static Set<Class<?>> scanForSerializable() {
		Reflections reflections = getReflections("org.fuserleer");
